...
//enum(열거체) 정의 : 집합을 이룬 자료형으로 생성
enum Rainbow {RED, ORANGE, YELLOW, GREEN, BLUE, INDIGO, VIOLET }


public class Ex08_Enum {
public static void main(String[] args) {
	//Enum (열거체) - 요소들을 명명한 값으로 집합을 이룬 자료형
	...
	int index = G.ordinal();
	System.out.println("GREEN 의 INDEX : " + (index+1));
	
	int index1 = R.ordinal();
	System.out.println("RED 의 INDEX : " + (index1+1));
